...
1. Open `notebooks/SPEI_Drought_Forecasting_Model.ipynb` in [Google Colab](https://colab.research.google.com/drive/1y7bx0soLL5PO_bLZXFCOBfbWsYLmZsSD?usp=sharing).
